...
\section{Client Tier}
  ...
  The Figure \ref{img:GUI Mockup} presents a simple content layout that have to be presented on a web-page in order to satisfy all possible user requirements. It contains:
