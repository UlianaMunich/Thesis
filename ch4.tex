...
\section{Application Tier}
  ...
  Application tier consists all logical modules: Web server, Sensor Registry, Data Hub and Web-based Frontend. All these modules connect to each other as shown on the Figure 4.4. 
    \begin{figure}[!ht]
    \centering
