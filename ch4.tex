...
\section{Client Tier}
  ...
  Figure \ref{img:GUI Mockup} presents a simple content layout that has to be presented on a web-page in order to satisfy all possible user requirements. It contains:
